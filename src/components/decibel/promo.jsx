...
module.exports =
  class Promo extends React.Component {
    ...
    componentDidMount () {
      ...
      var crossFadeInterval = setInterval(() => {
        ...
        var crossFadeEnterInterval = setTimeout(() => enterSlide.classList.remove('enter'), 200)
        this.setState({crossFadeEnterInterval})
      }, 6000)
      this.setState({crossFadeInterval})
    }
    componentWillUnmount () {
      let {crossFadeInterval, crossFadeEnterInterval} = this.state
      clearTimeout(crossFadeInterval)
      clearTimeout(crossFadeEnterInterval)
    }
    render () {
