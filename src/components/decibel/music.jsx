...
module.exports = class Music extends React.Component {
  render() {
    ...
    return (
      <section id="music" className="music-section section text-center">
        <div className="container">
          ...
          <div className="albums-block">
            ...
            <div className="cover-holder">
              <a className="cover-figure" href={album.linkUrl}>
                ...
                <img
                  className="cover-image img-responsive"
              ...
              <br />
              {album.preOrder ? (
                <a href="#" className="btn btn-sm btn-ghost-secondary">
                  Pre-Order Album
                </a>
              ) : (
                false
          ...
          {this.props.bandcampUrl ? (
            <div className="music-action">
              <a
                className="btn btn-ghost-primary"
                href={this.props.bandcampUrl}
              >
                Music on bandcamp
              </a>
            </div>
